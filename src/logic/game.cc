...
void Game::send_player_start_stop_building(Building& building, Building::OperationalStatus os) {
	send_player_command(
	   new CmdStartStopBuilding(get_gametime(), building.owner().player_number(), building, os));
}
